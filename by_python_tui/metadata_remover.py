...
def main_tui(stdscr):
    ...
    input_file = prompt_input(stdscr, "🏷️ Enter Media File Path")
    ...
    cmd = ["ffmpeg", "-y", "-i", input_file, "-map_metadata", "-1", "-c", "copy", output_file]
    run_ffmpeg_ui(stdscr, cmd, duration, total_frames, "Removing Metadata Losslessly...")
