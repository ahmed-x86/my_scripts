...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to WebM using full AMD VA-API (VP9) Pipeline...{NC}\n")
    send_notification("Video Converter", f"Starting full AMD VP9 conversion for {input_file}...", "video-x-generic")
    ...
    cmd = [
        ...
        "-c:v", "vp9_vaapi", "-c:a", "libopus", output_file
    ]
    ...
    if process.returncode == 0:
        ...
        send_notification("Success", f"AMD Hardware Conversion finished: {output_file}", "dialog-information")
    else:
