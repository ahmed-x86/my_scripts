...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to AV1 (SVT-AV1) with Progress Tracking...{NC}")
    send_notification("Video Converter", f"Starting AV1 conversion for {filename}...", "video-x-generic")
    ...
    if process.returncode == 0:
        ...
        send_notification("Success", f"AV1 conversion finished: {output_file}", "dialog-information")
    else:
        print(f"{RED}❌ Conversion failed{NC}")
        send_notification("Error", "AV1 conversion failed!", "dialog-error")
