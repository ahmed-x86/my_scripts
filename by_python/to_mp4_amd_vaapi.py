...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MP4 using AMD VA-API Encoding...{NC}\n")
    send_notification("Video Converter", f"Starting AMD MP4 conversion for {input_file}...", "video-x-generic")
