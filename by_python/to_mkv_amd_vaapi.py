...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MKV using AMD VA-API Encoding...{NC}\n")
    send_notification("Video Converter", f"Starting AMD MKV conversion for {input_file}...", "video-x-generic")
    ...
    cmd = [
        ...
        "-c:v", "h264_vaapi", "-c:a", "aac", output_file
    ]
    ...
    if process.returncode == 0:
        ...
        send_notification("Success", f"AMD Conversion finished: {output_file}", "dialog-information")
    else:
