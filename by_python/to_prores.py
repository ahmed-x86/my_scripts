...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to ProRes 422...{NC}\n")
    send_notification("Video Converter", f"Starting ProRes conversion for {input_file}...", "video-x-generic")

    # Run ffmpeg with ProRes 422 (Standard) parameters
    cmd = [
