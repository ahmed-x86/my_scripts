...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MP4 with CUDA Decoding...{NC}\n")
    send_notification("Video Converter", f"Starting CUDA-assisted MP4 conversion for {input_file}...", "video-x-generic")
