...
def main():
    ...
    print(f"{BLUE}🎯 Select WebP Mode:{NC}")
    print("1) Lossless (Best quality, larger size)")
    print("2) Lossy (Optimized for Web/GitHub - 75% quality)")
    print("3) High Compression (Smallest size - 50% quality)")
    ...
    print(f"{YELLOW}⏳ Converting to WebP...{NC}")

    duration = get_duration(input_file)
    
    # Run ffmpeg and capture its output
    cmd = ["ffmpeg", "-y", "-i", input_file] + dl_args + [output_file]
