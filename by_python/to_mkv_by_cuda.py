...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MKV with CUDA Decoding...{NC}\n")
    send_notification("Video Converter", f"Starting CUDA-assisted MKV conversion for {input_file}...", "video-x-generic")
