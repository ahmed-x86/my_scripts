...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MKV using NVIDIA NVENC Hardware Acceleration...{NC}\n")
    send_notification("Video Converter", f"Starting NVIDIA MKV conversion for {input_file}...", "video-x-generic")
    ...
    if process.returncode == 0:
        ...
        send_notification("Success", f"NVIDIA Conversion finished: {output_file}", "dialog-information")
    else:
        print(f"{RED}❌ Conversion failed (Make sure NVIDIA drivers and CUDA are installed){NC}")
