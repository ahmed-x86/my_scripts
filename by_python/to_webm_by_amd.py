...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to WebM with AMD VA-API Decoding...{NC}\n")
    send_notification("Video Converter", f"Starting AMD decoding WebM conversion for {input_file}...", "video-x-generic")
