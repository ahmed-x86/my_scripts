...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MP4 using NVIDIA NVENC...{NC}\n")
    send_notification("Video Converter", f"Starting NVIDIA MP4 conversion for {input_file}...", "video-x-generic")
