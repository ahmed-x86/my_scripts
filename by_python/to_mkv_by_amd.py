...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to MKV with AMD VA-API Decoding...{NC}\n")
    send_notification("Video Converter", f"Starting AMD-assisted MKV conversion for {input_file}...", "video-x-generic")
