...
def main():
    ...
    print(f"{YELLOW}⏳ Processing with full Intel VA-API Pipeline (MJPEG)...{NC}\n")
    send_notification("Video Converter", f"Starting full Intel VA-API pipeline for {input_file}...", "video-x-generic")
    ...
    if process.returncode == 0:
        ...
        send_notification("Success", f"Intel VA-API Pipeline finished: {output_file}", "dialog-information")
    else:
