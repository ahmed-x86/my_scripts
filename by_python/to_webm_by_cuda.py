...
def main():
    ...
    print(f"{YELLOW}⏳ Converting to WebM with CUDA Decoding...{NC}\n")
    send_notification("Video Converter", f"Starting CUDA-assisted WebM conversion for {input_file}...", "video-x-generic")
